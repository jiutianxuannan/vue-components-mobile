<template>
  <div class="yz-swipe">
    <div class="yz-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="yz-swipe-indicators" v-show="showIndicators">
      <div class="yz-swipe-indicator" v-for="(page, $index) in pages" :class="{ 'is-active': $index === index }">
      </div>
    </div>
  </div>
</template>
...
<script>
  import { once, addClass, removeClass } from './util';
...
<style scoped>
  ...
  .yz-swipe-items-wrap>div.is-active {
    display: block;
