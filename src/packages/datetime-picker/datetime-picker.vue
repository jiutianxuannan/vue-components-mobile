<template>
  <yz-popup v-model="visible" :closeOnClickModal="closeOnClickModal" position="bottom" class="yz-datetime">
    <yz-picker :slots="dateSlots" @change="onChange" :visible-item-count="visibleItemCount" class="yz-datetime-picker"
      ref="picker" show-toolbar>
      <span class="yz-datetime-action yz-datetime-cancel"
        @click="visible = false;$emit('cancel')">{{ cancelText }}</span>
      <span class="yz-datetime-action yz-datetime-confirm" @click="confirm">{{ confirmText }}</span>
    </yz-picker>
  </yz-popup>
</template>
...
<style scoped>
  ...
  .yz-datetime .picker-slot-wrapper,
  .yz-datetime .picker-item {
    -webkit-backface-visibility: hidden;
    backface-visibility: hidden;
  }

  .yz-datetime .picker-toolbar {
