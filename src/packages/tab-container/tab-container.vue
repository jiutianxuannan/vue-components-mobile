<template>
  <div @touchstart="startDrag" @mousedown="startDrag" @touchmove="onDrag" @mousemove="onDrag" @mouseup="endDrag"
    @touchend="endDrag" class="yz-tab-container">
    <div ref="wrap" class="yz-tab-container-wrap">
      <slot></slot>
    </div>
  </div>
</template>
...
<style scoped>
  ...
  .yz-tab-container .swipe-transition {
    -webkit-transition: -webkit-transform 150ms ease-in-out;
    transition: -webkit-transform 150ms ease-in-out;
    transition: transform 150ms ease-in-out;
  }

  .yz-tab-container-wrap {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
  }
